...
project_makefile = (ROOT / "Makefile").read_text()
testbench = (ROOT / "test/tb.v").read_text()
evidence_collector = (ROOT / "tools/collect_evidence.py").read_text()
...
for learning_file in ("map.md", "glossary.md", "labs.md", "checkpoints.md"):
